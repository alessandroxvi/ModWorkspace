...
public class BlockBamboo extends ElementsTheXVImod.ModElement {
	@GameRegistry.ObjectHolder("thexvimod:bamboo")
	public static final Block block = null;
	public BlockBamboo(ElementsTheXVImod instance) {
		super(instance, 105);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("thexvimod:bamboo", "inventory"));
	}
