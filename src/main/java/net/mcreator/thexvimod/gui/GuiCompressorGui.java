...
package net.mcreator.thexvimod.gui;
...
import net.mcreator.thexvimod.procedure.ProcedureCompress;
...
public class GuiCompressorGui extends ElementsTheXVImod.ModElement {
	public static int GUIID = 8;
	public static HashMap guistate = new HashMap();
	public GuiCompressorGui(ElementsTheXVImod instance) {
		super(instance, 109);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 26, 48) {
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 44, 48) {
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 125, 39) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				TheXVImod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("thexvimod:textures/compressorgui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Compress", 70, 11, -16777216);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 88, this.guiTop + 56, 80, 20, "Compress"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			TheXVImod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (buttonID == 0) {
			{
				...
				ProcedureCompress.executeProcedure($_dependencies);
			}
		}
	}
