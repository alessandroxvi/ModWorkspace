...
import net.mcreator.thexvimod.procedure.ProcedureTransformTool;
...
public class GuiGunMaker extends ElementsTheXVImod.ModElement {
	public static int GUIID = 7;
	public static HashMap guistate = new HashMap();
	public GuiGunMaker(ElementsTheXVImod instance) {
		super(instance, 102);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("thexvimod:textures/gunmaker.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("GunWorkBench", 61, 2, -16777216);
			this.fontRenderer.drawString("Tool", 25, 2, -16777216);
			this.fontRenderer.drawString("Material", 16, 38, -16777216);
			this.fontRenderer.drawString("output", 124, 20, -16777216);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 61, this.guiTop + 56, 60, 20, "Create"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureTransformTool.executeProcedure($_dependencies);
			}
		}
	}
