...
public class GuiGuncraftinggui extends ElementsTheXVImod.ModElement {
	public static int GUIID = 6;
	public static HashMap guistate = new HashMap();
	public GuiGuncraftinggui(ElementsTheXVImod instance) {
		super(instance, 58);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("thexvimod:textures/guncraftinggui.png");
		@Override
