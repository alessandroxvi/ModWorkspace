...
public class GuiGunworkbenchgui extends ElementsTheXVImod.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiGunworkbenchgui(ElementsTheXVImod instance) {
		super(instance, 51);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 16, 15) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 39, 14) {
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 15, 37) {
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 38, 34) {
			}));
			this.customSlots.put(5, this.addSlotToContainer(new Slot(internal, 5, 131, 30) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("thexvimod:textures/gunworkbenchgui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("output", 121, 18, -6736897);
		}
