...
public class ItemBlowDartGun extends ElementsTheXVImod.ModElement {
	@GameRegistry.ObjectHolder("thexvimod:blowdartgun")
	public static final Item block = null;
	public static final int ENTITYID = 1;
	public ItemBlowDartGun(ElementsTheXVImod instance) {
		super(instance, 52);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("thexvimod", "entitybulletblowdartgun"), ENTITYID).name("entitybulletblowdartgun").tracker(64, 1, true)
				.build());
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("thexvimod:blowdartgun", "inventory"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityArrowCustom.class, renderManager -> {
			return new RenderSnowball(renderManager, new ItemStack(Items.IRON_NUGGET, (int) (1)).getItem(), Minecraft.getMinecraft().getRenderItem());
		});
	}
	public static class RangedItem extends Item {
		public RangedItem() {
			...
			setMaxDamage(100);
			setFull3D();
			setUnlocalizedName("blowdartgun");
			setRegistryName("blowdartgun");
			maxStackSize = 1;
